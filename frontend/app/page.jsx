...
export default function Home(){
 ...
 return <div className="ds-app">
  ...
  <main className="ds-main">
   ...
   <section className="ds-hero"><span className="eyebrow">YOUR STOCK RESEARCH, IN ONE PLACE</span><h1>복잡한 종목 분석,<br className="ds-mobile-break"/> 핵심부터.</h1><p>가격 움직임과 그 이유, 긍정·부정 근거와 다음 이벤트를 한곳에서 확인하세요.</p></section>
   ...
   {!data?<section className="ds-welcome"><div className="ds-welcome-mark">⌁</div><h2>{loading?'일봉 데이터를 가져오고 있어요.':'티커를 입력하고 조회해 보세요.'}</h2><p>가격·급등락 원인 → 긍정·부정 뉴스 → 다가오는 이벤트</p><small>실제 조회 전에는 샘플 주가나 임의의 분석을 표시하지 않습니다.</small></section>:<>
    ...
    <nav className="ds-nav" aria-label="분석 이동"><a href="#desk-move">가격과 이유</a><a href="#desk-checks">뉴스·이벤트</a><a href="#desk-drivers">투자 논리 · 희석</a></nav>
