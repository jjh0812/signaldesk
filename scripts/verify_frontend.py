...
def validate_source(root: Path) -> None:
    ...
    for token in ('id="sd-stock-drivers-action"', 'id="sd-dilution-scan-action"',
                  '투자 논리 자동 분석', 'SEC 지금 확인', 'id="sd-thesis-summary"', 'id="sd-thesis-bottlenecks"'):
